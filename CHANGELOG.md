...
- The icons now tell you what they are. On a hotspot card, every bird group that’s actually around this month shows its name under the icon (the groups that aren’t stay as quiet unlabelled icons, so the row doesn’t get noisy). And on a hotspot’s species table and in your Target and Seen lists, each bird’s type · size · nest · behaviour icons now carry their word too. No more guessing which silhouette is which.
