...
export const CHANGELOG = [
  {
    ...
    changes: [
      ...
      'County lines are now black and dashed — a man-made boundary should look like one, instantly distinct from the red roads and blue rivers. And you can zoom much further in: about 2.5× deeper on the hotspot map (far enough to fill the screen with one lake) and 3× deeper on the county picker.',
