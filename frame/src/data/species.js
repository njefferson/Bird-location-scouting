...
export const SPECIES = [
  ...
  { code: 'grnher', name: 'Green Heron', photoability: 0.7, status: 'summer', abundance: 0.3,
  ...
  { code: 'calqua', name: 'California Quail', photoability: 0.72, status: 'resident', abundance: 0.55,
  ...
  { code: 'comgol', name: 'Common Goldeneye', photoability: 0.66, status: 'winter', abundance: 0.3,
  ...
  { code: 'doccor', name: 'Double-crested Cormorant', photoability: 0.66, status: 'resident', abundance: 0.5,
  ...
  { code: 'bulori', name: "Bullock's Oriole", photoability: 0.7, status: 'summer', abundance: 0.4,
  ...
  { code: 'wewpew', name: 'Western Wood-Pewee', photoability: 0.6, status: 'summer', abundance: 0.3,
  ...
  { code: 'comrav', name: 'Common Raven', photoability: 0.62, status: 'resident', abundance: 0.5,
  ...
  { code: 'gocspa', name: 'Golden-crowned Sparrow', photoability: 0.64, status: 'winter', abundance: 0.6,
