...
row('labelled action ink on card2  ', '#2c2318', '#f2ead9', 4.5);
row('shot-list on: accent on wash  ', '#7a4a10', '#f4e6cd', 4.5);
row('seen on: ink on slate-wash    ', '#2c2318', '#dbe7f0', 4.5);
...
row('labelled action ink on card2  ', '#f2e9da', '#2a2318', 4.5);
row('shot-list on: accent on wash  ', '#f0d9b0', '#3a2c15', 4.5);
row('seen on: ink on slate-wash    ', '#f2e9da', '#1e2c38', 4.5);
